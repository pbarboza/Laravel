...
<div id="content">
  <div id="content-header">
   <div id="breadcrumb"><a href="/index" class="tip-bottom" data-original-title="Ir al inicio"><i class="icon-home"></i> Inicio</a> <a href="/usuario" class="tip-bottom" data-original-title="Ir al listado de usuarios"></i> Usuarios</a><a href="/nuevousuario" class="current"> Nuevo Usuario</a> </div>
    <h1><i class="icon icon-plus"></i> NUEVO USUARIO</h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      {!!Form::open (['route' => 'usuario.store', 'method' =>'post', 'novalidate', 'class' => 'form-horizontal'])!!} 
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="Usuario" id="Usuario" class="span7">
                </div>
              </div>
              ...
              <div class="controls">
                  <input type="password" name="Pass" id="Pass" class="span7">
              </div>  
